			...
			<div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--12-col-phone">
				<div class="mdl-card mdl-cell mdl-cell--1-offset-desktop mdl-cell--10-col mdl-cell--12-col-phone container mdl-shadow--4dp">
					<div class="mdl-card__title">
						<h2 class="mdl-card__title-text">Cadastro de usuários</h2>
					</div>
					<div class="container">
						<form action="<?= base_url()?>Usuario/cadastrar" method="POST">
							...
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell--1-offset mdl-cell--5-col-desktop">
								<input class="mdl-textfield__input" type="text" id="nome" name="nome"  title="SOMENTE LETRAS" required pattern="[a-zA-Z0-9\s]+">
							...
							<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-cell--1-offset mdl-cell--5-col-desktop">
								<input class="mdl-textfield__input" type="text" id="usuario" name="user" required>
